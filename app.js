  ...
  showModal() {
    ...
    div.innerHTML = `
      <div class="modal-box">
        ...
        <div class="modal-sub">Enter your TikTok username below.<br>Your stream must already be live before connecting.</div>
        <input type="text" class="modal-input" id="tiktok-username-input" placeholder="@yourusername" autocomplete="off">
        <div class="modal-btns">
          <button class="modal-btn-go" onclick="TikTok.connect()">Connect</button>
          <button class="modal-btn-cancel" onclick="TikTok.closeModal()">Cancel</button>
        </div>
        <div class="modal-error" id="modal-error"></div>
      </div>`;
    document.body.appendChild(div);
    const inp = document.getElementById('tiktok-username-input');
    inp.focus();
    inp.addEventListener('keydown', e => { if (e.key === 'Enter') TikTok.connect(); });
  },
  connect() {
